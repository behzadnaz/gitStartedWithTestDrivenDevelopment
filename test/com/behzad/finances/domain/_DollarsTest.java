...
public class _DollarsTest {
    ...
    public void addition(){
        ...
        assertEquals("positive result",new Dollars(40), new Dollars(10).add(new Dollars(30)));
    }
    @Test
    public void subtraction(){
        assertEquals("positive results",new Dollars(20), new Dollars(50).subtract(new Dollars(30)));
