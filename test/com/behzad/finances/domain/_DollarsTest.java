...
public class _DollarsTest {
    ...
    public void parseNumbersAndDollarsAndNegativeSigns(){
        ...
        assertEquals("negative numbers", ValidDollars.create(-42), Dollars.parse("-42"));
    ...
    public void parseParentheses(){
        ...
        assertEquals("number in parenthesis", ValidDollars.create(-42), Dollars.parse("(42)"));
    ...
    public void parsingTheDoubleOfDeathDoesntHangMachine(){
       ...
       // assertEquals(ValidDollars.create("2.2250738585072012e-308"), );
